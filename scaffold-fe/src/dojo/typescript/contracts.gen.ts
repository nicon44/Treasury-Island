...
export async function setupWorld(provider: DojoProvider) {
    ...
    function gameroom() {
        ...
        // Call the `buy_items` system with the specified Account and calldata
        const buy_items = async (props: { account: Account, game_id: bigint, item_id: number }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
        ...
        return {
            world, start_game, hide_loot, set_trap, buy_items, dig_for_loot, end_round
        };
    }
