...
// node_modules/@dojoengine/core/dist/index.js
var Provider = class {
  /**
...
var DojoProvider = class extends Provider {
  ...
  async entity(model2, keys, offset = 0, length = 0, layout) {
    try {
      return await this.contract.call("entity", [
        shortString_exports.encodeShortString(model2),
        keys.length,
        ...keys,
        offset,
        length,
  ...
  async execute(account, call, nameSpace, details = {}) {
    ...
    try {
      return await (account == null ? void 0 : account.execute(calls, void 0, details));
    } catch (error) {
      this.logger.error("Error occured: ", error);
      throw error;
    }
...
//# sourceMappingURL=chunk-NDLG7IOO.js.map
