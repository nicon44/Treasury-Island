...
// Generated by dojo-bindgen on Fri, 30 Aug 2024 13:40:08 +0000. Do not modify this file manually.
...
export async function setupWorld(provider: DojoProvider) {
    ...
    function lobby() {
        ...
        return {
            register_player, update_pfp, create_room, invite_player, refuse_invite, join_room, close_room, world
        };
    }
    ...
    function gameroom() {
        ...
        const hide_loot = async (props: { account: Account, game_id: bigint, loot_length: number, x0: number, y0: number, x1: number, y1: number }) => {
            try {
                return await provider.execute(
                    props.account,
                    {
        ...
        return {
            world, start_game, hide_loot, dig_for_loot, end_round
        };
    }
