        ...
        fn buy_items(ref self: ContractState, game_id: u128, item_id: u8) {
            ...
            match item_id {
                ...
                1 => {
                    ...
                    let newly_bought_loot_object = LootObjectTrait::new(
                        game_id, player, current_global_loot_id + 1, constants::ONE_BY_ONE_DIMS
                    );
                ...
                2 => {
                    ...
                    let current_global_loot_id = self.global_loot_id.read();
                    let newly_bought_loot_object = LootObjectTrait::new(
                        game_id, player, current_global_loot_id + 1, constants::TWO_BY_ONE_DIMS
                    );
                    self.global_loot_id.write(current_global_loot_id + 1);
                    player_loottracker.loot_ids.append(current_global_loot_id + 1);
                ...
                3 => {
                    ...
                    let current_global_loot_id = self.global_loot_id.read();
                    let newly_bought_loot_object = LootObjectTrait::new(
                        game_id, player, current_global_loot_id + 1, constants::THREE_BY_ONE_DIMS
                    );
                    self.global_loot_id.write(current_global_loot_id + 1);
                    player_loottracker.loot_ids.append(current_global_loot_id + 1);
                ...
                4 => {
                    ...
                    let current_global_loot_id = self.global_loot_id.read();
                    let newly_bought_loot_object = LootObjectTrait::new(
                        game_id, player, current_global_loot_id + 1, constants::FOUR_BY_ONE_DIMS
                    );
                    self.global_loot_id.write(current_global_loot_id + 1);
                    player_loottracker.loot_ids.append(current_global_loot_id + 1);
                ...
                5 => {
                    ...
                    let current_global_loot_id = self.global_loot_id.read();
                    let newly_bought_loot_object = LootObjectTrait::new(
                        game_id, player, current_global_loot_id + 1, constants::FIVE_BY_ONE_DIMS
                    );
                    self.global_loot_id.write(current_global_loot_id + 1);
                    player_loottracker.loot_ids.append(current_global_loot_id + 1);
        ...
        fn dig_for_loot(ref self: ContractState, game_id: u128, x: u8, y: u8) -> bool {
            ...
            if (found_loot) {
                ...
                if (new_hidden_indices.len() == 0) {
                    ...
                    //     game_id, player, current_global_loot_id+1,
                    //     related_loot_object.loot_length);
                    // self.global_loot_id.write(current_global_loot_id+1);
